...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep  8 14:52:17 2022
...
N=[2000,2000] # size should be the dimension of the system #its also the number of samples per each dimension
...
def gen_batch_data():
    ...
    batch_init=batch_data(full_domain, N, block_len, prob.cons_init)
